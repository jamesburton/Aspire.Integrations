...
public sealed class PlaneResource(
    string name,
    ...
    : ContainerResource(name), IResourceWithConnectionString
{
    ...
    public ReferenceExpression ConnectionStringExpression =>
        ...
        {
            ParameterResource secretKey => ReferenceExpression.Create($"Endpoint={HttpEndpoint.Property(EndpointProperty.Url)};Key={secretKey}"),
